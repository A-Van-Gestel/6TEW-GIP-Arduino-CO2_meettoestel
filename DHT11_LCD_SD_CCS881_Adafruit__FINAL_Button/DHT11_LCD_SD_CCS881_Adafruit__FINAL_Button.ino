...
long previousMillisSensor = 0;        // will store last time sensor was updated
...
void Button() {
  // read the pushbutton input pin:
    if(currentMillis - previousMillisButton > 250) {
    // save the last time the program has run
...
//----------DHT11 Readings----------
  ...
  if(currentMillis - previousMillisSensor > delaytime) {
    // save the last time the program has run
