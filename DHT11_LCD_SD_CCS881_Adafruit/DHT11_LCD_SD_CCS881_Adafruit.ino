...
//----------Serial Monitor----------
  ...
  Serial.print(F("Themp: ")); Serial.print(temp);  Serial.print(F("C"));
  Serial.println();
...
//----------SD Card----------
  SDcard = SD.open("results.txt", FILE_WRITE);
  SDcard.print(timer);    // Write timer
  SDcard.print(F(";"));
  SDcard.print(h);    // Write Humidity
  SDcard.print(F(";"));
  SDcard.print(t);    // Write Temerature
  SDcard.print(F(";"));
  SDcard.print(co2);    // Write CO2
  SDcard.print(F(";"));
